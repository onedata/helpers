...
/**
 * @c CephRadosHelperParams stores the internal helper parameters specific to
 * CephHelper.
 */
class CephRadosHelperParams : public KeyValueAdapterParams {
public:
    static std::shared_ptr<CephRadosHelperParams> create(
